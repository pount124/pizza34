...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
   ...
   var currentOrders = Object.keys(orederSummary.current_orders);
   ...
   if(currentOrders.length > 0 && currentOrders==dish.id){
    ...
    saveRatingButton.addEventListeners("click",()=>{
      document.getElementById("rating-modal-div").style.display = "none";

      var rating = document.getElementById("rating-input").value;
      var feeback = document.getElementById("feedback-input").value;
